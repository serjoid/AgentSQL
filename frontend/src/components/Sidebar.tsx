  ...
  const mockTables = [
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'price', type: 'decimal', primary: false },
      ],
    },
  ]
  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-b border-border-primary">
        <button className="w-full flex items-center gap-2 px-3 py-2 bg-accent-primary hover:bg-accent-secondary text-white rounded-md text-sm transition-colors">
